...
@Testcontainers
class DeleteUserApiWithOneUsersIT implements WithAssertions {
    ...
    void shouldReturnOneUser() {
        var jsonPath =
                given().when()
                        .port(SERVER.getPort())
                        .delete("/users/1d0bbcb2-9ef6-11ef-ba7c-6f55e9414db3")
                        .then()
                        .assertThat()
                        .statusCode(200)
                        .and()
                        ...
                        .body()
                        .jsonPath();
        assertThat(jsonPath.getObject("", UserDto.class))
                .isEqualTo(new UserDto("1d0bbcb2-9ef6-11ef-ba7c-6f55e9414db3", "John", "Smith"));
    }
}
